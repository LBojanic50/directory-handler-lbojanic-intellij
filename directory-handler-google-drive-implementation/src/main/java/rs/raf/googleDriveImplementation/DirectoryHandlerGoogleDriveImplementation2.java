...
public class DirectoryHandlerGoogleDriveImplementation2 implements IDirectoryHandlerGoogleDriveSpecification {
    @Override
    public Credential getCredentials(InputStream inputStream, String CREDENTIALS_FILE_PATH, NetHttpTransport HTTP_TRANSPORT, JsonFactory JSON_FACTORY, List<String> SCOPES, String TOKENS_DIRECTORY_PATH) throws IOException {
        if (inputStream == null) {
