...
public interface IDirectoryHandlerSpecification<T> {
     ...
     */
    void createDirectory(final String directoryPathsString) throws IOException, FileAlreadyExistsException, DirectoryHandlerExceptions.MaxFileCountExceededException;
    /**
     ...
     */
    void createFile(final String filePathsString) throws Exception, FileAlreadyExistsException;
    /**
     ...
     * @throws IOException
     */
    void createRepository(final String repositoryNames) throws Exception;
    /**
     ...
     * @throws IOException
     */
    void createRepository(final String repositoryNames, final DirectoryHandlerConfig directoryHandlerConfig) throws Exception;
    /**
